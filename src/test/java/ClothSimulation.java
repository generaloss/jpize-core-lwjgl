...
public class ClothSimulation extends JpizeApplication {
    ...
    private final Vec2f prev_grab;

    private final VertexBatch point_batch;
    private final VertexBatch line_batch;
